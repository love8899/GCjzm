...
namespace Wfm.Plugin.Widgets.GoogleAnalytics
{
    ...
    /// </summary>
    public class GoogleAnalyticPlugin : BasePlugin
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary { { "Namespaces", "Wfm.Plugin.Widgets.GoogleAnalytics.Controllers" }, { "area", null } };
        }
        ...
        public void GetDisplayWidgetRoute(string widgetZone, out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            {
                {"Namespaces", "Wfm.Plugin.Widgets.GoogleAnalytics.Controllers"},
                {"area", null},
