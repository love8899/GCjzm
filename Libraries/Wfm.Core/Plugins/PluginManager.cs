...
namespace Wfm.Core.Plugins
{
    ...
    public class PluginManager
    {
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains(WfmVersion.CurrentVersion, StringComparer.InvariantCultureIgnoreCase))
                        {
        ...
        private static IEnumerable<KeyValuePair<FileInfo, PluginDescriptor>> GetDescriptionFilesAndDescriptors(DirectoryInfo pluginFolder)
        {
            ...
            //it's required: http://www.wfmcommerce.com/boards/t/17455/load-plugins-based-on-their-displayorder-on-startup.aspx
        ...
        private static Assembly PerformFileDeploy(FileInfo plug)
        {
            if (plug.Directory.Parent == null)
                throw new InvalidOperationException("The plugin directory for the " + plug.Name +
                                                    " file exists in a folder outside of the allowed wfmCommerce folder heirarchy");
        ...
        private static FileInfo InitializeFullTrust(FileInfo plug, DirectoryInfo shadowCopyPlugFolder)
        {
            ...
            return CopyPlugIn(plug, shadowCopiedPlug);
        }
        ...
        private static FileInfo InitializeMediumTrust(FileInfo plug, DirectoryInfo shadowCopyPlugFolder)
        {
            ...
            if (shadowCopiedPlug.Exists)
            {
                ...
                else
                {
                    ...
                    //More info: http://www.wfmcommerce.com/boards/t/11511/access-error-wfmplugindiscountrulesbillingcountrydll.aspx?p=4#60838
        ...
        private static FileInfo CopyPlugIn(FileInfo plug, FileInfo shadowCopiedPlug)
        {
            try
            {
