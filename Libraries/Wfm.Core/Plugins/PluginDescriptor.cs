...
namespace Wfm.Core.Plugins
{
    public class PluginDescriptor : IComparable<PluginDescriptor>
    {
        public PluginDescriptor()
        {
            ...
            this.LimitedToFranchises = new List<int>();
        }
        ...
        /// <summary>
        /// Gets or sets the supported versions of wfmCommerce
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the list of franchise identifiers in which this plugin is available. If empty, then this plugin is available in all franchises
        /// </summary>
        public virtual IList<int> LimitedToFranchises { get; set; }
