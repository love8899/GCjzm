...
namespace Wfm.Services.Blogs
{
    ...
    public partial interface IBlogService
    {
        ...
        IPagedList<BlogPost> GetAllBlogPosts(int franchiseId, int languageId,
        ...
        /// <param name="showHidden">A value indicating whether to show hidden records</param>
        /// <returns>Blog posts</returns>
        IPagedList<BlogPost> GetAllBlogPostsByTag(int franchiseId, int languageId, string tag,
        ...
        IList<BlogPostTag> GetAllBlogPostTags(int franchiseId, int languageId, bool showHidden = false);
        ...
        IList<BlogComment> GetAllComments(int accountId);
