...
namespace Wfm.Services.Forums
{
    public static class ForumExtensions
    {
        ...
        public static string FormatForumSignatureText(this string text)
        {
            ...
            text = Wfm.Core.Html.HtmlHelper.FormatText(text, false, true, false, false, false, false);
            return text;
        }
        ...
        public static string FormatPrivateMessageText(this PrivateMessage pm)
        {
            ...
            text = Wfm.Core.Html.HtmlHelper.FormatText(text, false, true, false, true, false, false);
        ...
        /// <summary>
        /// Get forum last post account
        /// </summary>
        /// <param name="forum">Forum</param>
        /// <param name="accountService">Account service</param>
        /// <returns>Account</returns>
        public static Account GetLastPostAccount(this Forum forum, IAccountService accountService)
        {
            if (forum == null)
                throw new ArgumentNullException("forum");

            return accountService.GetAccountById(forum.LastPostAccountId);
        }
        ...
        /// <param name="accountService">Account service</param>
        /// <returns>Account</returns>
        public static Account GetLastPostAccount(this ForumTopic forumTopic, IAccountService accountService)
        {
            if (forumTopic == null)
                throw new ArgumentNullException("forumTopic");

            return accountService.GetAccountById(forumTopic.LastPostAccountId);
        }
    }
}
