...
namespace Wfm.Services.Localization
{
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        /// {0} : language ID
        /// </remarks>
        private const string LOCALSTRINGRESOURCES_ALL_KEY = "Wfm.lsr.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// {1} : resource key
        /// </remarks>
        private const string LOCALSTRINGRESOURCES_BY_RESOURCENAME_KEY = "Wfm.lsr.{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string LOCALSTRINGRESOURCES_PATTERN_KEY = "Wfm.lsr.";
        #endregion
       ...
       // private readonly IEventPublisher _eventPublisher;
        ...
        public virtual void InsertLocaleStringResource(LocaleStringResource localeStringResource)
        {
            ...
            localeStringResource.CreatedOnUtc = localeStringResource.UpdatedOnUtc = DateTime.UtcNow;
        ...
        public virtual void UpdateLocaleStringResource(LocaleStringResource localeStringResource)
        {
            if (localeStringResource == null)
                throw new ArgumentNullException("localeStringResource");
            localeStringResource.UpdatedOnUtc = DateTime.UtcNow;
        ...
        /// <summary>
        /// Gets all resources asynchronous queryable.
        /// </summary>
        /// <returns></returns>
        public IQueryable<LocaleStringResource> GetAllResourcesAsQueryable()
        {
            var query = from c in _lsrRepository.Table
                        orderby c.ResourceName
                        select c;
