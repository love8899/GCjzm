...
{
    public partial class T4_2018Service : IT4BaseService
    {
        #region Fields
        ...
        private readonly IRepository<T4_2018> _t4s;
        ...
        public T4_2018Service(
            IWebHelper webHelper,
            IRepository<Franchise> franchises,
            IRepository<T4_2018> t4s,
        ...
        public string GetEmployeeT4PDF(int franchiseId, int t4Id, bool isEncrypted, out int candidateId)
        {
            ...
            var pdfTemplate = @"t4-fill-18e.pdf";
