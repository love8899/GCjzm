...
{
    public partial class T4_2015Service : IT4BaseService
    {
        #region Fields

        private const int _TaxYear = 2015;
        ...
        private readonly IRepository<T4_2015> _t4s;
        ...
        public T4_2015Service(
            IWebHelper webHelper,
            IRepository<Franchise> franchises,
            IRepository<T4_2015> t4s,
