...
{
    public partial class T4_2021Service : IT4BaseService
    {
        #region Fields
        ...
        private readonly IRepository<T4_2021> _t4s;
        ...
        public T4_2021Service(
            IWebHelper webHelper,
            IRepository<Franchise> franchises,
            IRepository<T4_2021> t4s,
        ...
        public string GetEmployeeT4PDF(int franchiseId, int t4Id, bool isEncrypted, out int candidateId)
        {
            ...
            var pdfTemplate = @"t4-fill-21e.pdf";
