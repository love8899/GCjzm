...
namespace Wfm.Services.Payroll
{
    ...
    public partial class RL1_2019Service : IRL1BaseService
    {
        ...
        private readonly IRepository<RL1_2019> _rl1s;
        ...
        public RL1_2019Service(
            IWebHelper webHelper,
            IRepository<Franchise> franchises,
            IRepository<RL1_2019> rl1s,
        ...
        public string GetEmployeeRL1PDF(int franchiseId, int rl1Id, bool isEncrypted, out int candidateId)
        {
            ...
            var pdfTemplate = @"RL-1(2019-10)pre-copie2.pdf";
