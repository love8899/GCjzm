...
namespace Wfm.Services.Payroll
{
    ...
    public partial class RL1_2021Service : IRL1BaseService
    {

        #region Fields

        private const int _TaxYear = 2021;
        ...
        private readonly IRepository<RL1_2021> _rl1s;
        ...
        public RL1_2021Service(
            IWebHelper webHelper,
            IRepository<Franchise> franchises,
            IRepository<RL1_2021> rl1s,
        ...
        public string GetEmployeeRL1PDF(int franchiseId, int rl1Id, bool isEncrypted, out int candidateId)
        {
            ...
            var pdfTemplate = @"RL-1(2021-10)pre-copie2.pdf";
