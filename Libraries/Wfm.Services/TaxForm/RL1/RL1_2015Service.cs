...
namespace Wfm.Services.Payroll
{
    ...
    public partial class RL1_2015Service : IRL1BaseService
    {
        ...
        private readonly IRepository<RL1_2015> _rl1s;
        ...
        public RL1_2015Service(
            IWebHelper webHelper,
            IRepository<Franchise> franchises,
            IRepository<RL1_2015> rl1s,
        ...
        public string GetEmployeeRL1PDF(int franchiseId, int rl1Id, bool isEncrypted, out int candidateId)
        {
            ...
            var pdfTemplate = @"rl-1(2015-10)_Employee.pdf";
