...
namespace Wfm.Services.Payroll
{
    ...
    public partial class RL1_2016Service : IRL1BaseService
    {
        ...
        private readonly IRepository<RL1_2016> _rl1s;
        ...
        public RL1_2016Service(
            IWebHelper webHelper,
            IRepository<Franchise> franchises,
            IRepository<RL1_2016> rl1s,
        ...
        public string GetEmployeeRL1PDF(int franchiseId, int rl1Id, bool isEncrypted, out int candidateId)
        {
            ...
            var pdfTemplate = @"RL-1.P(2016-10)copie2.pdf";
