...
namespace Wfm.Services.Payroll
{
    ...
    public partial class RL1_2018Service : IRL1BaseService
    {

        #region Fields

        private const int _TaxYear = 2018;
        ...
        private readonly IRepository<RL1_2018> _rl1s;
        ...
        public RL1_2018Service(
            IWebHelper webHelper,
            IRepository<Franchise> franchises,
            IRepository<RL1_2018> rl1s,
        ...
        public string GetEmployeeRL1PDF(int franchiseId, int rl1Id, bool isEncrypted, out int candidateId)
        {
            ...
            var pdfTemplate = @"RL-1(2018-10)pre-copie2.pdf";
