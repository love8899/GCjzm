...
namespace Wfm.Services.Tasks
{
    ...
    public partial class TaskThread : IDisposable
    {
        ...
        internal TaskThread()
        {
            this._tasks = new Dictionary<string, ScheduledTask>();
            this.Seconds = 10 * 60;
        }
        ...
        private void Run()
        {
            ...
            this.IsRunning = true;
            foreach (ScheduledTask task in this._tasks.Values)
            {
                task.Execute();
            }
        ...
        /// Get a list of tasks
        /// </summary>
        public IList<ScheduledTask> Tasks
        {
            get
            {
                ...
                return new ReadOnlyCollection<ScheduledTask>(list);
            }
        }
