...
namespace Wfm.Services.Helpers
{
    ...
    public partial class DateTimeHelper : IDateTimeHelper
    {
        ...
        /// <returns>Customer time zone; if customer is null, then default franchise time zone</returns>
        public virtual TimeZoneInfo GetCustomerTimeZone(Account account)
        {
            //registered user
            ...
            if (timeZoneInfo == null)
                timeZoneInfo = this.DefaultFranchiseTimeZone;

            return timeZoneInfo;
        }

        /// <summary>
        /// Gets or sets a default franchise time zone
        /// </summary>
        public virtual TimeZoneInfo DefaultFranchiseTimeZone
        {
            get
            {
                TimeZoneInfo timeZoneInfo = null;
        ...
        public virtual TimeZoneInfo CurrentTimeZone
        {
            get
            {
                return GetCustomerTimeZone(_workContext.CurrentAccount);
            }
            set
            {
                if (!_dateTimeSettings.AllowCustomersToSetTimeZone)
        ...
        //public TimeZoneInfo GetCustomerTimeZone(Account account)
        //{
