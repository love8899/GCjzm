...
namespace Wfm.Data
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        {
            //pass some table names to ensure that we have wfmCommerce 2.X installed
            var tablesToValidate = new[] { "Franchise", "Account", "Company", "Country", "StateProvince", "City" };
            ...
            var initializer = new CreateTablesIfNotExist<WfmObjectContext>();
